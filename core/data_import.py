...
def import_data_with_date_index(datapath, ambient_channel_number, regex_temp):
...
def import_data_without_date_index(datapath, ambient_channel_number, regex_temp):
